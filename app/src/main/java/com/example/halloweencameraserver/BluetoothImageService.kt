...
class BluetoothImageService(
    ...
    private fun updateUserInterfaceTitle() {
        ...
        Log.d(
            TAG,
            "updateUserInterfaceTitle() " + mNewState + " -> " + iState
        )
        mNewState = iState
    ...
    fun write(out: ByteArray?) {
        ...
        synchronized(this) {
            if (iState != STATE_CONNECTED) return
            r = mConnectedThread
        }
    ...
    private inner class AcceptThread(secure: Boolean) : Thread() {
        ...
        override fun run() {
            ...
            while ( iState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized(this@BluetoothImageService) {
                        when ( iState ) {
    ...
    private inner class ConnectThread(private val mmDevice: BluetoothDevice, secure: Boolean) :
        ...
        override fun run() {
            ...
            synchronized(this@BluetoothImageService) { mConnectThread = null }
    ...
    companion object {
        ...
        // Debugging
        private const val TAG = "BluetoothImageService"

        // Name for the SDP record when creating server socket
        private const val NAME_SECURE = "BluetoothImageSecure"
        private const val NAME_INSECURE = "BluetoothImageInsecure"
